  ...
  try {
    ...
    if (needCLodop()) {
      ...
      if (!LODOP) {
        ...
        if (CLODOP && CLODOP.CVERSION < '3.0.9.3') {
    ...
    LODOP.SET_LICENSES('深圳云路供应链科技有限公司', '9B32B3CAB83F42F52AAC6AC6F8801D7A374', '深圳雲路供應鏈科技有限公司', '8DB5C879EA93FE3CB1BDD5E34CB7CB151CC')
    LODOP.SET_LICENSES('THIRD LICENSE', '', 'Shenzhen Yunlu Supply Chain Technology Co., Ltd.', '37A8526098B15B8CD0F8000C23C7E041263')
